...
namespace Template.Game
{
    internal class CannonBall : Sprite
    {
        ...
        public CannonBall(Sprite player, Vector2 fireTowards, int bulletDamage, int type)
        {
            damage = bulletDamage;
            ...
            RotationHelper.VelocityInCurrentDirection(this, 100, 0);
            ...
            {
                new SmokeParticle(Position2D, Velocity, Vector2.Zero, 5);
            }
